    ...
    return (
        <DialogRoot open={open} onOpenChange={onOpenChange}>
            <DialogContent>
                ...
                <div className="relative bg-[var(--brand-default)] text-white px-6 pt-6 pb-5">
                    <div className="absolute top-0 left-0 right-0 h-1 bg-[var(--accent-default)]" />
                    <div className="flex items-center gap-2 mb-2">
                        <span className="inline-flex h-1.5 w-1.5 rounded-full bg-[var(--accent-default)]" />
                        <span className="text-[10px] uppercase tracking-[0.18em] font-bold text-[var(--brand-soft)]">
                    ...
                    <DialogTitle className="utsa-display-black text-white text-[26px] leading-tight">
                        ...
                        <span className="text-[var(--accent-default)] mx-2">·</span>
                        <span>{course?.title ?? section.title}</span>
                    </DialogTitle>
                    <DialogDescription className="mt-2 text-[12px] text-[var(--brand-soft)]">
                ...
                <DialogBody className="space-y-6">
                    {/* Instructor + RMP */}
                    <section className="rounded-xl border border-[var(--border-default)] bg-[var(--surface-default)] p-4">
                        <div className="flex items-center justify-between gap-3 mb-3">
                            <div className="flex items-center gap-3">
                                <div className="w-10 h-10 rounded-full bg-[var(--brand-soft)] text-[var(--brand-default)] flex items-center justify-center font-bold">
                                ...
                                <div>
                                    <div className="text-[14px] font-bold text-[var(--ink-strong)]">
                                        {section.instructorName}
                                    </div>
                            ...
                            <div className="grid grid-cols-3 gap-3">
                                <div className="rounded-xl bg-[var(--surface-muted)] p-3">
                                    ...
                                    <div className="flex items-baseline gap-1 mt-1">
                                        ...
                                        />
                                        <span className="text-[20px] font-black text-[var(--ink-strong)] utsa-tabular">
                                ...
                                <div className="rounded-xl bg-[var(--surface-muted)] p-3">
                                    ...
                                    <div className="text-[20px] font-black text-[var(--ink-strong)] utsa-tabular mt-1">
                    ...
                    {/* Schedule */}
                    <section className="rounded-xl border border-[var(--border-default)] bg-[var(--surface-default)] p-4">
                        <h4 className="text-[10px] uppercase tracking-wider text-[var(--ink-subtle)] font-bold mb-3">
                            When + Where
                        </h4>
                        {meeting ? (
                    ...
                    {course?.description && (
                        <section className="rounded-xl border border-[var(--border-default)] bg-[var(--surface-default)] p-4">
                            <h4 className="text-[10px] uppercase tracking-wider text-[var(--ink-subtle)] font-bold mb-2">
                                Description
                            </h4>
                            <p className="text-[12px] leading-relaxed text-[var(--ink-default)]">
                                {course.description}
                            </p>
                            {course.prereqsRaw && (
                                <p className="text-[11px] mt-2 text-[var(--ink-muted)]">
                        ...
                        <section className="rounded-xl border border-[var(--border-default)] bg-[var(--surface-default)] p-4">
                            <div className="flex items-center justify-between gap-2">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-[12px] font-semibold text-[var(--ink-strong)] utsa-tabular">
                    ...
                    <section className="rounded-xl border border-[var(--border-default)] bg-[var(--surface-default)] p-4">
                        <div className="flex items-center justify-between gap-2 mb-3">
                            <div className="flex items-center gap-2">
                                <FileText className="w-4 h-4 text-[var(--accent-default)]" />
                                <h4 className="text-[10px] uppercase tracking-wider text-[var(--ink-subtle)] font-bold">
                                    Syllabus Library
                                </h4>
                            </div>
                            {syllabus.data && (
                        ...
                        {syllabus.loading ? (
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center gap-2 text-[12px] text-[var(--ink-default)]">
                                    <Building2 className="w-3.5 h-3.5 text-[var(--ink-muted)]" />
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    <div className="rounded-lg bg-[var(--surface-muted)] p-2.5">
                                        <div className="text-[9px] uppercase tracking-wider text-[var(--ink-subtle)] font-bold">
                                            Tracked courses
                                        </div>
                                        <div className="text-[18px] font-black text-[var(--ink-strong)] utsa-tabular leading-tight mt-0.5">
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    rel="noreferrer"
                                    className="flex items-center gap-2 rounded-lg border border-[var(--border-default)] bg-[var(--surface-default)] hover:bg-[var(--surface-muted)] p-2.5 text-[12px] font-semibold text-[var(--ink-strong)] transition-colors"
                                >
                                    <FileText className="w-3.5 h-3.5 text-[var(--accent-default)]" />
                                    <span>Open syllabi for {section.courseId}</span>
                                    <ExternalLink className="w-3 h-3 ml-auto text-[var(--ink-muted)]" />
                                </a>
                            </div>
                        ) : (
                            <p className="text-[12px] text-[var(--ink-muted)]">
                    ...
                    {r && (
                        <section>
                            <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="flex items-center gap-2 rounded-xl border border-[var(--border-default)] bg-[var(--surface-default)] hover:bg-[var(--surface-muted)] p-3 text-[12px] font-semibold text-[var(--ink-strong)] transition-colors"
                            >
                                <Star className="w-4 h-4 text-[var(--accent-default)]" />
...
const Stat = ({ icon: Icon, label, value }: StatProps) => (
    <div className="rounded-lg bg-[var(--surface-muted)] p-3">
        <div className="flex items-center gap-1.5 text-[10px] uppercase tracking-wider text-[var(--ink-subtle)] font-bold">
            <Icon className="w-3 h-3" />
            {label}
        </div>
        <div className="text-[13px] font-bold text-[var(--ink-strong)] mt-1 utsa-tabular truncate">
            {value}
        </div>
    </div>
);
